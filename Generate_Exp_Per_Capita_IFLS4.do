...
use "IN\2007\b1_ks1.dta", clear;
keep hhid07 ks1type ks02 ;
...
drop ks1type;
reshape wide ks02 , i(hhid07) j(r_ks1type);
sort hhid07;
save `r1', replace; 

*Non food expenditure/month (more frequent goods);
use "IN\2007\b1_ks2.dta", clear;
keep hhid07 ks2type ks06;
...
sum r_ks2type if hhid07=="293430003" & r_ks2type==12;
replace r_ks2type=12 if hhid07=="293430003" & r_ks2type==.;
tab r_ks2type, missing;
drop ks2type;
reshape wide ks06, i(hhid07) j(r_ks2type);
sort hhid07;
save `r2', replace; 

*Non food expenditure/year (less frequent goods);
use "IN\2007\b1_ks3.dta", clear;
keep hhid07 ks3type ks08 ks09a;
...
drop ks3type;
reshape wide ks08 ks09a, i(hhid07) j(r_ks3type);
sort hhid07;
save `r3', replace; 

*Other expenditure;
use "IN\2007\b1_ks0.dta", clear;
...
keep hhid07 ks04b ks10aa ks10ab ks11aa ks11ab ks12aa ks12ab ks12bb;
sort hhid07;
save `r4', replace; 

*housing expenditure;
use "IN\2007\b2_kr.dta", clear;
keep hhid07 kr03 kr04a kr04ax kr05a kr05ax;
...
* more frequent goods;
tab hhid07 if ks061==. & ks062==. & ks063==. & ks064==. & ks065==. & ks066==. & ks067==. & ks068==. & ks069==. & ks0610==. & ks0611==. & ks0612==.;
egen nfmfm = rowtotal(ks06*), missing;
label var nfmfm "Pengeluaran non pangan untuk barang yang lebih sering per bulan";
* less frequent goods;
tab hhid07 if ks081==. & ks082==. & ks083==. & ks084==. & ks085==. & ks086==. & ks087==.;
...
* education;
tab hhid07 if ks10aa==. & ks10ab==. & ks11aa==. & ks11ab==. & ks12aa==. & ks12ab==. & ks12bb==.;
...
count if nfoodexpm==.;
sum nfoodexpm;
* nfoodexpm>1.e+9: hhid07: "217080000" dan ks09a3:4.00000e+10 (pengeluaran untuk kesehatan setahun terakhir);
...
sort hhid07;
display _N;
keep hhid07 expm expmjt ;
save `q4', replace; 

display _N;
save OUT\1306_hhchar07, replace; 
